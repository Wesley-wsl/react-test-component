...
describe("Counter Component", () => {
    ...
    test("não deve iniciar o título com as classes counter__title--increment e counter__title--decrement", () => {
        render(<Counter />);
    ...
    test("deve adicionar a classe counter__title--increment no título quando o valor for maior do que 0", () => {
        render(<Counter />);
    ...
    test("deve adicionar a classe counter__title--decrement no título quando o valor for menor do que 0", () => {
        render(<Counter />);
